# # Here, we have to predict whether a malarial cell is healthy or detected.
#
# import  numpy as np
# np.random.seed(1000)
# import cv2
...
#
# image_directory='images/cell_images2/'
#
# SIZE=64
# dataset=[]
# label=[]
...
#
# history=model.fit(x=np.array(X_train), y=y_train, batch_size=64,verbose=1, epochs=25, validation_split=0.1,shuffle=False)
#
