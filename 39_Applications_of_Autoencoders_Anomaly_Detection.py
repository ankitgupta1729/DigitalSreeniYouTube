# input can be image or any data. For example, we take the healthy cell images and
# we train the images and if the data that does not fit on healthy cells is anomaly
# we should have the annotated data
# we train on un-anomaly data and generated data is anomaly data
"""
...
# "good" is not amomaly, "bad" is anomaly
...
# here we are not taking convolutional layers because we don't have image data to capture spatial info
